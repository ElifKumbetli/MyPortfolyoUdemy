        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<int>(type: "nvarchar(200)", nullable: false),
                    SubDescription = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<int>(type: "int", nullable: false),
                    Url = table.Column<int>(type: "int", nullable: false),
                    Descriptiont = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
